...
class Leads(models.Model):
    ...
    ledstype = models.ForeignKey(Period, on_delete=models.CASCADE,blank=True, null=True)
...
class Groups(models.Model):
    ...
    room = models.ForeignKey(Rooms, on_delete=models.CASCADE, related_name='courses')
...
class Finance(models.Manager):
    def get_queryset(self):
        return super().get_queryset().annotate(
            ...
            total_profit=models.Sum('income__amount') - models.Sum('expenses__amount'),
