...
from .views import xisobot, lead_to_sudent, student_delete, student_update, student_create, student, teacher, course_delete, group_delete, group_update, course_update, add_group, course_create, group, home, leads, lead_delete, lead_update, period, period_add, course

urlpatterns = [
    # path('', home, name='home'),
    path('leads/', leads, name='leadregister'),
    path("students/", student, name="students"),
    path("xisobot/", xisobot, name="xisobot"),
